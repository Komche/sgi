      ...
      <form role="form" method="post" enctype="multipart/form-data">
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <textarea required class="form-control" id="editor1" name="description" placeholder="description du rôle"></textarea>
          </div>
        </div>

        <div class="form-group">
          <label for="files">Image</label>
          <input type="file" required class="form-control" id="files" name="files" placeholder="Sélctionner l'image">
        </div>
        <!-- /.box-body -->

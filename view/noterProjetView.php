              ...
              <div class="col-md-6">
                <div style="margin-bottom: 100px; margin-top: 100px" class="card">
                  <div class="box">
                    ...
                    <p> <?= limit_text($value['description'], 30) ?> <a href="index.php?action=detailProjet&projet=<?= $value['id_projet'] ?>" type="button" title="Voir plus" class="btn btn-note-edit btn-warning center-block">Détails</a></p>

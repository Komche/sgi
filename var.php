<?php
        ...
        $this->config["host"] = '185.98.131.128';
        $this->config["db_name"] = 'coron1363653';
        $this->config["username"] = 'coron1363653';
        $this->config["password_"] = 'qtl1xghbdn';
...
$this->config['tables']['users'] = ['id','first_name','last_name','matricule','phone_number','email','type_agent','created_at','updated_at','photo','role','status','password_',];

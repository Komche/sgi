...
$this->config["tables"] = ['actions','candidat','equipe','files','forum','inscription','module','module_role','note','pays','projet','region','roles','type_agent','users',];
...
$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['candidat']['id'] = ['id_candidat'];$this->config['tables']['equipe']['id'] = ['id_equipe'];$this->config['tables']['files']['id'] = ['id'];$this->config['tables']['forum']['id'] = ['id_forum'];

$this->config['tables']['inscription'] = ['id_inscription','etat',];

$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['candidat']['id'] = ['id_candidat'];$this->config['tables']['equipe']['id'] = ['id_equipe'];$this->config['tables']['files']['id'] = ['id'];$this->config['tables']['forum']['id'] = ['id_forum'];$this->config['tables']['inscription']['id'] = ['id_inscription'];

$this->config['tables']['module'] = ['id','name','icon','description','action_url','sub_module',];

$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['candidat']['id'] = ['id_candidat'];$this->config['tables']['equipe']['id'] = ['id_equipe'];$this->config['tables']['files']['id'] = ['id'];$this->config['tables']['forum']['id'] = ['id_forum'];$this->config['tables']['inscription']['id'] = ['id_inscription'];$this->config['tables']['module']['id'] = ['id'];

$this->config['tables']['module_role'] = ['id','role_id','module',];

$this->config['tables']['actions']['id'] = ['id'];$this->config['tables']['candidat']['id'] = ['id_candidat'];$this->config['tables']['equipe']['id'] = ['id_equipe'];$this->config['tables']['files']['id'] = ['id'];$this->config['tables']['forum']['id'] = ['id_forum'];$this->config['tables']['inscription']['id'] = ['id_inscription'];$this->config['tables']['module']['id'] = ['id'];$this->config['tables']['module_role']['id'] = ['id'];
